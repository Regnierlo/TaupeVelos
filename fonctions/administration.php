...
function afficherAdmin(){
			if(isset($_SESSION["login"])){
				echo '<a href="gproduits.php"><p>Gestion de produits</p></a>';
				echo '<a href="gutilisateurs.php"><p>Gestion d\'utilisateurs</p></a>';
				echo '<a href="commandes.php"><p>Visualiser les commandes<p></a>';
			}	
